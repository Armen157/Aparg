...
<head>
    ...
    <script>
        ...
        channel.bind('SecondPersonEvent', function(data) {
...
<div class="chat-container">
    <div class="chat-with">Person 2</div>
    <div class="messages-box">
        <div class="container"></div>
    </div>
    <div class="type-msg">
        <input id="chat" type="text" name="text" placeholder="Type your message...">
        <button id="click"><i class="fa fa-paper-plane" aria-hidden="true"></i></button>
    </div>
</div>
</body>
</html>
